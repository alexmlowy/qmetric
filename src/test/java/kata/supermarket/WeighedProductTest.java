...
class WeighedProductTest {
   ...
   @ParameterizedTest
   @MethodSource
   void itemFromWeighedProductHasExpectedUnitPrice(String productName, String pricePerKilo, String weightInKilos, String expectedPrice) {
   ...
   static Stream<Arguments> itemFromWeighedProductHasExpectedUnitPrice() {
      return Stream.of(
              Arguments.of("Milk", "100.00", "1.00", "100.00"),
              Arguments.of("Milk", "100.00", "0.33333", "33.33"),
              Arguments.of("Milk", "100.00", "0.33335", "33.34"),
              Arguments.of("Milk", "100.00", "0", "0.00")
      );
   }
